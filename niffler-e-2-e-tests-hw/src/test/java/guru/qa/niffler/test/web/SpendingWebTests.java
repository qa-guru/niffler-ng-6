...
//        Selenide.sleep(50000L);
//                .login(user.getUsername(), user.getPassword())
                mainPage.createNewSpending(spend1)
    ...
    @Test
    void testForConditions1(
            @ApiLogin(username = "naruto", password = "12345")
            UserJson user,
            @ApiLogin(username = "kakashi", password = "12345", setupBrowser = false)
            UserJson user2
            ) {
