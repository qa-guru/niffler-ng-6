...
public class Databases {
  ...
  public static <T> T transaction(Function<Connection, T> function, String jdbcUrl, TransactionLevelEnum transactionLevel) {
  ...
  public static <T> T xaTransaction(TransactionLevelEnum transactionLevel, XaFunction<T>... actions) {
  ...
  public static void xaTransaction(TransactionLevelEnum transactionLevel, XaConsumer... actions) {
    UserTransaction ut = new UserTransactionImp();
    try {
      ut.begin();
  ...
  public static void transaction(Consumer<Connection> consumer, String jdbcUrl, TransactionLevelEnum transactionLevel) {
    Connection connection = null;
    try {
      connection = connection(jdbcUrl);
      connection.setAutoCommit(false);
